...
# ╔═╡ baf4ec10-866f-11ef-1425-5b4c7ba7209b
using JuMP, HiGHS, EAGO # Ipopt, MadNLP, Cbc

# ╔═╡ b4b4c668-4148-43d3-b309-90be330d59bc
using MAiNGO, Ipopt

# ╔═╡ 5cd12234-1ed8-4640-807c-d2e280376c43
begin
	ENV["CPLEX_STUDIO_BINARIES"] = "/work/CPLEX_Studio_Community2211/cplex/bin/x86-64_linux/"

	using CPLEX
end

# ╔═╡ 058574a0-9aad-4289-b025-b66dc1e13aaa
begin
	...
	phi = (1 + sqrt(5))/2
	phi_bits = round(Int, phi*B_factor)
	
	@variable(model, 0 <= tau_pos <= B, Int)

	# @constraint(model, bint == round(phi/tau_factor))

	@variable(model, 0 <= qphi <= Emax, Int)
	# @constraint(model, qphi == bint * 2^tau_pos)
	
	@objective(model, Min, phi_bits - (qphi * 2^tau_pos))
	println(model)
	optimize!(model)
	println(value(bint))
end

# ╔═╡ aba904e6-c7e9-4520-b788-8793212cb9ad
value(bint)*tau_factor
...
MAiNGO = "19f71287-e05d-461c-be93-c347e7defd4d"
...
manifest_format = "2.0"
project_hash = "3894a03befd46f8083f5da7318a5bdd02e470bd6"
...
[[deps.MAiNGO]]
deps = ["JSON", "Libdl", "MAiNGO_jll", "MathOptInterface"]
git-tree-sha1 = "cc9d4ffdd61b3d89a1df3723c4cc8e1fea7d2b7f"
uuid = "19f71287-e05d-461c-be93-c347e7defd4d"
version = "0.2.2"

[[deps.MAiNGO_jll]]
deps = ["Artifacts", "CompilerSupportLibraries_jll", "JLLWrappers", "Libdl"]
git-tree-sha1 = "c5b900032e3978889b07101cf343e12fe1f1479a"
uuid = "6ab0fed5-a098-5dc6-978d-ebec7ca9d2e4"
version = "0.7.2+0"
...
git-tree-sha1 = "deba1ddcf2f313f506f7e67ae3891dfe1647be80"
